        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="text-gray-400 max-w-md">
              Empowering students through personalized education site. Our
              mission is to unlock every student's full potential through
            ...
            <div className="pt-2">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.youtube.com/c/CSwithSANJOY"
                  aria-label="YouTube"
                  className="bg-slate-800 hover:bg-gradient-to-br hover:from-red-600 hover:to-red-400 p-3 rounded-full transition-all duration-300 text-gray-400 hover:text-white"
                >
                  <YouTubeIcon />
                </a>
                <a
                  href="https://www.facebook.com/cswithsanjoy"
                  aria-label="Facebook"
                  className="bg-slate-800 hover:bg-blue-600 p-3 rounded-full transition-all duration-300 text-gray-400 hover:text-white"
                >
                  <FacebookIcon />
                </a>
                <a
                  href="#"
                  aria-label="Twitter"
                  className="bg-slate-800 hover:bg-blue-400 p-3 rounded-full transition-all duration-300 text-gray-400 hover:text-white"
                >
                  <TwitterIcon />
                </a>
                <a
                  ...
                  className="bg-slate-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 p-3 rounded-full transition-all duration-300 text-gray-400 hover:text-white"
                >
                  <InstagramIcon />
                </a>
                <a
                  href="https://www.linkedin.com/in/sanjoyghoshcs"
                  aria-label="LinkedIn"
                  className="bg-slate-800 hover:bg-blue-700 p-3 rounded-full transition-all duration-300 text-gray-400 hover:text-white"
                >
                  <LinkedinIcon />
                </a>
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Kolkata</p>
                  </div>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">NA</p>
                  </div>
                </li>
