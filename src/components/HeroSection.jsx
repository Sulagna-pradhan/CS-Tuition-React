  ...
  return (
    <section className="pt-12 sm:pt-16 md:pt-20 lg:pt-24 pb-20 min-h-screen w-full bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        <div
          className="absolute -top-20 -right-20 w-96 h-96 bg-blue-900 rounded-full opacity-20 blur-3xl parallax"
          data-speed="2"
        ></div>
        <div
          className="absolute top-1/3 -left-20 w-72 h-72 bg-indigo-900 rounded-full opacity-20 blur-3xl parallax"
          data-speed="3"
        ></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-60 h-60 bg-purple-900 rounded-full opacity-20 blur-3xl parallax"
          data-speed="1.5"
        ></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-6rem)]">
          <div className="pt-4 sm:pt-6 md:pt-8 lg:pt-0">
            ...
            <motion.h1
              {...slideUp}
              className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-blue-400 to-purple-400 leading-tight"
            >
            ...
            >
              Join our community of passionate students and experienced
              educator. Discover our features designed to help you excel in
            ...
            <motion.div {...slideIn} className="flex flex-wrap gap-4 mb-8">
              <a
                href="/features"
                className="group flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-500 hover:from-indigo-500 hover:to-blue-400 text-white rounded-lg font-medium shadow-lg shadow-indigo-900/40 transition-all hover:shadow-xl hover:shadow-indigo-900/60"
              >
                Explore Features
                <FontAwesomeIcon
                  icon={faArrowRight}
            ...
            <motion.div
              {...scaleIn}
              className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-gray-400"
            >
              {[
                "Built by students",
          ...
          <div className="relative hidden lg:block">
            <motion.div {...scaleIn} className="relative z-10">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-indigo-900/40">
                ...
                <motion.div
                  {...float}
                  className="absolute left-4 top-24 bg-gray-800 p-3 rounded-lg shadow-xl border border-gray-700"
                >
                  <div className="flex items-center space-x-3">
                    <div className="flex -space-x-2">
                      ...
                      <div className="h-8 w-8 rounded-full bg-green-600 flex items-center justify-center text-white text-xs">
                        AM
                      </div>
                ...
                <motion.div
                  {...float}
                  className="absolute right-4 bottom-24 bg-gray-800 p-3 rounded-lg shadow-xl border border-gray-700"
                >
